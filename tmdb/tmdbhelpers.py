  ...
  def __init__(self, imdb_id, tmbd_id="", force_update_cache=False):
    ...
    if not force_update_cache:
      ...
      if cached_full_entity:
        pprint("--------------------------------------")  
        pprint("Fetched CACHED TMDB entity successfuly for IMDB ID: " + self.imdb_id + " with TMDB ID: " + cached_tmdb_id)
    ...
    append_seasons = "season/1,season/2,season/3,season/4,season/5," + 
